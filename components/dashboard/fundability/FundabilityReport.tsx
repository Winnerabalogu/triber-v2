...
import { CheckCircle, Info, Briefcase, Users, Activity, ShieldCheck, FileText } from "lucide-react";
    ...
    <div className="space-y-8">      
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="md:col-span-3 bg-background p-6 rounded-lg border border-foreground/60">
          ...
          {/* This part would be dynamically generated from another service call in a real app */}

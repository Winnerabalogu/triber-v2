...
const mockNotifications = [
  {
    id: 1,
    icon: MessageSquare,
    text: "New message from Chakra Soft.",
    time: "5 min ago",
    read: false,
  },
  {
  ...
  },
  {
    id: 4,
    icon: MessageSquare,
    text: "Follow-up from Innovate Capital.",
    time: "1 day ago",
    read: false,
  },
];
          ...
          >
            ...
            <div className="max-h-80 overflow-y-auto scrollbar-hide">
              {mockNotifications.map((notif) => (
                ...
                >
                  <div className="flex items-start gap-3 p-4 hover:bg-muted/50 border-b border-border rounded-lg last:border-b-0">
                    <div
                      className={cn(
